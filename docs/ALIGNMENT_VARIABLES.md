...
> See also: [PHASE0_DESIGN_LOCK.md](PHASE0_DESIGN_LOCK.md), [ENCOUNTER_MODEL.md](ENCOUNTER_MODEL.md), [alignment.variables.json](alignment.variables.json), [TASKLIST.md](TASKLIST.md).
