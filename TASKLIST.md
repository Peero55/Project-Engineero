...
> **Before making changes:** Read [docs/ALIGNMENT_VARIABLES.md](docs/ALIGNMENT_VARIABLES.md), [config/alignment.variables.json](config/alignment.variables.json), [docs/PHASE0_DESIGN_LOCK.md](docs/PHASE0_DESIGN_LOCK.md), [docs/ENCOUNTER_MODEL.md](docs/ENCOUNTER_MODEL.md).  
> **Sources:** [docs/CURSOR_HANDOFF.md](docs/CURSOR_HANDOFF.md), Starting_Scaffolding.md, [docs/SYSTEM_DESIGN_DAILY_QUESTIONS.md](docs/SYSTEM_DESIGN_DAILY_QUESTIONS.md)  
> **Product PRD:** [.cursor/rules/PRD.md](.cursor/rules/PRD.md) — use with alignment; technical conflicts defer to alignment + this file.
...
|------------------------|---------------|-------------------------|
| Phase 1 — Next + Tailwind + `.cursorrules` | Scaffold + rules | `apps/web`, Tailwind; **`.cursorrules`** (root pointer) + `.cursor/rules/` |
...
*Aligned to:* [docs/SYSTEM_DESIGN_DAILY_QUESTIONS.md](docs/SYSTEM_DESIGN_DAILY_QUESTIONS.md)
...
*Implement per [docs/ENCOUNTER_MODEL.md](docs/ENCOUNTER_MODEL.md): battles operate on encounters, not just questions.*
...
- [x] `config/alignment.variables.json` — machine-readable alignment
...
*See [.cursor/rules/alignment.mdc](.cursor/rules/alignment.mdc) for full alignment rules.*
